 ...
 * @author EMMANUEL
 */
public class adminRedressal extends javax.swing.JFrame {
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        Logger.getLogger(adminRedressal.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (double i = 0.1; i <= 1.0; i += 0.1) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(adminRedressal.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//    method to immediately update the status value in the database
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminRedressal.class
